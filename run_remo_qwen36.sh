...
#SBATCH --nodes=1
#SBATCH --mem=64gb
#SBATCH --output=log/remo36_%j.out
#SBATCH --error=log/remo36_%j.out
#SBATCH --job-name=ReMo36
...
# ============================================================
# HARNESS + ReMo RUN — qwen36 only
#
#   System: HARNESS+REMO — run_monthly_baseline_remo
#   Model:  qwen36 — Qwen3.6-35B-A3B  (TP=4, 4×A100)
#   RUN_TAG — names remo_results_<tag>/ directory
# ============================================================
RUN_TAG="remo_v1"   # <-- keep in sync with run_remo_qwen25.sh
...
echo "=========================================="
echo "HARNESS + ReMo RUN — qwen36  [tag: ${RUN_TAG}]"
echo "=========================================="
echo "System:     HARNESS+REMO (plain reward model, raw returns)"
echo "Model:      qwen36 (Qwen3.6-35B-A3B)  —  4×A100, TP=4"
...
echo ""
echo "=========================================="
echo "Generating qwen36 per-universe plots..."
echo "=========================================="
...
echo ""
echo "=========================================="
echo "HARNESS + ReMo qwen36 COMPLETE  [tag: ${RUN_TAG}]"
echo "=========================================="
echo "Period:  ${START_DATE} -> ${END_DATE}"
echo "Capital: \$${INITIAL_CAPITAL}  |  Fees: 15 bps"
echo ""
echo "Result directories (remo_results_${RUN_TAG}/qwen36_*):"
ls -lhd "${ROOT_DIR}/remo_results_${RUN_TAG}"/qwen36_*/ 2>/dev/null | awk '{print "  "$NF}' \
    || echo "  (none)"
echo "=========================================="
